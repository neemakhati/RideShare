    ...
    <KeyboardAvoidingView>
      <ScrollView>
        <View style={styles.container}>
          ...
          {nameError ? (
            <Text style={{ color: "red", fontSize: 13 }}>{nameError}</Text>
          ) : null}
          ...
          {phoneError ? (
            <Text style={{ color: "red", fontSize: 13 }}>{phoneError}</Text>
          ) : null}
          ...
          {passwordError ? (
            <Text style={{ color: "red", fontSize: 13 }}>{passwordError}</Text>
          ) : null}
          ...
          {cpasswordError ? (
            <Text style={{ color: "red", fontSize: 13 }}>{cpasswordError}</Text>
          ) : null}
