    ...
    <KeyboardAvoidingView>
      <ScrollView>
        <View style={styles.container}>
          ...
          {nameError ? (
            <Text style={{ color: "#DB5461", fontSize: 13 }}>{nameError}</Text>
          ) : null}
          ...
          {emailError ? (
            <Text style={{ color: "#DB5461", fontSize: 13 }}>{emailError}</Text>
          ) : null}
          ...
          {phoneError ? (
            <Text style={{ color: "#DB5461", fontSize: 13 }}>{phoneError}</Text>
          ) : null}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={data.num}
              onChangeText={(value) => {
                setData((prev) => ({ ...prev, num: value }));
              }}
            />
          </View>
          {numError ? (
            <Text style={{ color: "#DB5461", fontSize: 13 }}>{numError}</Text>
          ) : null}
          ...
          {passwordError ? (
            <Text style={{ color: "#DB5461", fontSize: 13 }}>
              {passwordError}
            </Text>
          ) : null}
