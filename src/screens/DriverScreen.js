            ...
            >
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        {rideDetails ? (
                            <>
                                <Text style={styles.detailItem}>Passenger: {rideDetails.user_name}</Text>
                                <Text style={styles.detailItem}>Destination: {rideDetails.destination}</Text>
                                <Text style={styles.detailItem}>Pickup Location: {rideDetails.origin}</Text>
